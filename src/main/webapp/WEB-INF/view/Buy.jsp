...
<div class="bg">
    <div class="con1">
        <form class="form-horizontal" role="form" action="buy" method="post">
            ...
            <div class="form-group">
                <label for="buyid" class="col-sm-2 control-label">流水号</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="buyid" id="buyid" placeholder="流水号">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="num" class="col-sm-2 control-label">用户名</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="buyname" id="buyname" placeholder="输入您的用户名" >
                </div>
            </div>
